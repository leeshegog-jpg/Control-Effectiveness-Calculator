...
| 21 | [R1 Milestone 3D — Incident Implementation Readiness & Scope](21-r1-milestone-3d-incident-implementation-readiness.md) — reconciliation pass proposing an 8-slice Incident implementation breakdown against the now-frozen baseline (ACR-004/005); **§12: 3D-1 (Incident persistence — ORM model + repository + tests) GO'd, implemented, and CLOSED 2026-08-19**, merged to `main` at `f115590`; 3D-2 through 3D-7 not started |
