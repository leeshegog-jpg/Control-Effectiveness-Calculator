...
| Status | **Resolved (2026-08-12), scope decided; ACR raised.** [ACR-005](../../.acr/ACR-005-incident-general-notifiable-incident-rule.md), 2026-08-12, **Pending Approval** — not itself implementation authorization. `osr_notified`/"OSR" meaning: **`TO_BE_CONFIRMED`** (ADR-006 §11 — one candidate, "Office of State Revenue," checked and ruled out 2026-08-12; not to be renamed or reinterpreted by inference), out of ACR-005's scope. |
...
- ~~D6~~ — **Resolved (scope), ACR raised.** [ADR-006](../../.adr/ADR-006-incident-notification-rule-formal-defer.md) — deferred 2026-08-12, resolved same day: `whsq_notified` = internal, R10's scope-equivalent extended to general WHS Act categories via a new rule, Safety Systems Manager/48hr/10yr. **[ACR-005](../../.acr/ACR-005-incident-general-notifiable-incident-rule.md) raised 2026-08-12 — Pending Approval.** `osr_notified`/"OSR" meaning: **`TO_BE_CONFIRMED`** — "Office of State Revenue" checked and ruled out (2026-08-12) as not fitting this WHS/amusement-park context; the field is explicitly untouched, not renamed, not reinterpreted; residual open item (ADR-006 §11), out of ACR-005's scope.
