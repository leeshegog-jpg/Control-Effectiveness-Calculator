...
**Two ACRs are now implicated:** D4 — [ACR-004](../../.acr/ACR-004-incident-openapi-extension.md), **Approved and contract-implemented 2026-08-11**. D6 — [ACR-005](../../.acr/ACR-005-incident-general-notifiable-incident-rule.md), raised and **Approved 2026-08-12**, not yet incorporated (its four artefacts remain unedited pending a separate GO — same gap ACR-004 had between approval and implementation). **No ACR was required or raised for D2, D3, or D5 — all resolved via ADR only.**
