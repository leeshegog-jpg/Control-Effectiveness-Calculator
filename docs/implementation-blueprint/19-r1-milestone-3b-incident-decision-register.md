...
| Status | **Resolved (2026-08-12), scope decided; ACR raised.** [ACR-005](../../.acr/ACR-005-incident-general-notifiable-incident-rule.md), 2026-08-12, **Pending Approval** — not itself implementation authorization. "OSR"/`osr_notified` remains a residual open item (ADR-006 §11), out of ACR-005's scope. |
...
**Resolution order as executed:** D1 (closed) → D7 (accepted) → D2 (**Accepted, ADR-003**) → D4 (**Approved + contract-implemented, ACR-004**) → D3 (**Accepted, ADR-004**) → D5 (**Accepted, ADR-005**) → **D6** (**Deferred then Resolved, ADR-006**; **[ACR-005](../../.acr/ACR-005-incident-general-notifiable-incident-rule.md) raised, Pending Approval**; OSR/`osr_notified` residual open). **All seven decision points now have a recorded disposition; D6's follow-on ACR is raised but not yet approved.**
...
**Two ACRs are now implicated:** D4 — [ACR-004](../../.acr/ACR-004-incident-openapi-extension.md), **Approved and contract-implemented 2026-08-11**. D6 — [ACR-005](../../.acr/ACR-005-incident-general-notifiable-incident-rule.md), raised 2026-08-12 per ADR-006 §10, **Pending Approval**. **No ACR was required or raised for D2, D3, or D5 — all resolved via ADR only.**
...
- ~~D6~~ — **Resolved (scope), ACR raised.** [ADR-006](../../.adr/ADR-006-incident-notification-rule-formal-defer.md) — deferred 2026-08-12, resolved same day: `whsq_notified` = internal, R10's scope-equivalent extended to general WHS Act categories via a new rule, Safety Systems Manager/48hr/10yr. **[ACR-005](../../.acr/ACR-005-incident-general-notifiable-incident-rule.md) raised 2026-08-12 — Pending Approval.** "OSR" meaning unanswered; `osr_notified` explicitly untouched, residual open item (ADR-006 §11), out of ACR-005's scope.
