...
## Architecture Change Requests — Pending

| ACR # | Title | Raised | Status | Basis | Would touch |
|---|---|---|---|---|---|
| [ACR-004](../../.acr/ACR-004-incident-openapi-extension.md) | Incident Domain — OpenAPI Extension (Investigation, `incident_hazards`/`REVEALS`, incident-scoped Evidence) | 2026-08-09 | **Pending Approval** | [IB19](19-r1-milestone-3b-incident-decision-register.md) D4; [ADR-003](../../.adr/ADR-003-incident-investigation-action-sibling-structure.md) | `10-openapi.yaml` only, additive-only — no schema/Neo4j/ontology/code change proposed |

Design Baseline remains **v1.1** unless and until ACR-004 is approved — no artefact has been changed by raising it.
