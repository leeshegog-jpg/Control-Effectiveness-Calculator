...
## Architecture Change Requests — Approved, Not Yet Incorporated

| ACR # | Title | Raised | Approved | Basis | Would touch |
|---|---|---|---|---|---|
| [ACR-005](../../.acr/ACR-005-incident-general-notifiable-incident-rule.md) | Incident Domain — New Rule (R23) Extending Notification Propagation to General WHS Act Notifiable-Incident Categories | 2026-08-12 | **2026-08-12** | [IB19](19-r1-milestone-3b-incident-decision-register.md) D6; [ADR-006](../../.adr/ADR-006-incident-notification-rule-formal-defer.md) | `03-postgresql-schema.sql` (new `incidents.is_notifiable_incident` column), `10-openapi.yaml`, `02-neo4j-node-relationship-model.md`, `07-inference-rules-catalogue.md` (new rule R23 — R10 itself untouched) — no application code |

ACR-005 is approved but **none of its four artefacts have been edited** — same intermediate state ACR-004 passed through between 2026-08-11's approval and its later contract implementation. A separate, explicit GO is required before `03-postgresql-schema.sql`, `10-openapi.yaml`, `02-neo4j-node-relationship-model.md`, or `07-inference-rules-catalogue.md` are touched. `osr_notified`/"OSR" remains `TO_BE_CONFIRMED` (ADR-006 §11), untouched by ACR-005 either way.

Nothing in ACR-005 has been implemented — proposal only. `07-inference-rules-catalogue.md` is unchanged; R10 remains exactly as specified. Design Baseline remains v1.1 pending approval.
