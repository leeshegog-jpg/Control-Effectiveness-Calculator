...
## Architecture Change Requests — Pending Approval

| ACR # | Title | Raised | Basis | Would touch |
|---|---|---|---|---|
| [ACR-005](../../.acr/ACR-005-incident-general-notifiable-incident-rule.md) | Incident Domain — New Rule (R23) Extending Notification Propagation to General WHS Act Notifiable-Incident Categories | 2026-08-12 | [IB19](19-r1-milestone-3b-incident-decision-register.md) D6; [ADR-006](../../.adr/ADR-006-incident-notification-rule-formal-defer.md) | `03-postgresql-schema.sql` (new `incidents.is_notifiable_incident` column), `10-openapi.yaml`, `02-neo4j-node-relationship-model.md`, `07-inference-rules-catalogue.md` (new rule R23 — R10 itself untouched) — no application code |
