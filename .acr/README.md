...
| [ACR-004](ACR-004-incident-openapi-extension.md) | Incident Domain — OpenAPI Extension (Investigation, `incident_hazards`/`REVEALS`, incident-scoped Evidence) | **Pending Approval** (raised 2026-08-09) | [19-r1-milestone-3b-incident-decision-register.md](../docs/implementation-blueprint/19-r1-milestone-3b-incident-decision-register.md) D4; basis: [ADR-003](../.adr/ADR-003-incident-investigation-action-sibling-structure.md) |

Design Baseline is currently **v1.1** as a result of ACR-002 and ACR-003. ACR-004 does not change the Design Baseline unless and until approved.
